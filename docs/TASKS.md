...
| ART-001 | READY | Persist durable Blob upload and seal | WSP-001, DATA-006 | bounded local BlobStore and migration tests prove ordered idempotent chunks, fsync plus atomic content-addressed seal, exact status recovery, Team-scoped dedupe, quotas, expiry, and sealed-but-unbound restart recovery |
