...
| RUN-011 | READY | Pin Artifact content in durable Run delivery | TASK-010, CON-010, RUN-002 | delivery tests prove one payload freezes canonical Artifact revision and content metadata across retry/restart, authorizes only its target Device, and never resolves live publication state |
