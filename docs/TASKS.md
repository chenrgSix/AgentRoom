...
| ROOM-007 | ACTIVE | Govern Room Agent collaboration policy | ROOM-004, RUN-006, DISC-007, WEB-032 | close the audit gaps for redacted reply routing, Agent-side `@all`, longest exact-name matching, crash-recoverable handoff intents, and revision-safe multi-client Room settings before restoring the prior Server/Web/E2E/browser completion evidence |
