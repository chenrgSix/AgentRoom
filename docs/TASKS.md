...
| BRG-008 | ACTIVE | Publish standalone Bridge release artifacts | BRG-007 | published GitHub Release builds five CGO-free archives, injects the tag version, and attaches SHA-256 checksums |
