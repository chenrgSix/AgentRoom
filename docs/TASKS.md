...
| BRG-024 | ACTIVE | Edit paired Bridge connection settings | BRG-012, BRG-021 | token-authenticated Console and desktop coverage proves a paired owner can edit the central service URL and HTTPS trust without replacing Agent configuration or Device credentials; validation and active-work fences apply, a running Bridge reconnects, and a stopped Bridge remains stopped |
