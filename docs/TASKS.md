...
| TASK-006 | DONE | Add structured long-term provenance Memory | TASK-004, TASK-005 | migration 0032, Member-authorized Room/Task APIs, Context Planner, 44 contract fixtures, and Bridge prompt/session regressions prove typed immutable entries with Message/Artifact/Run/Discussion provenance, monotonic scope revisions, explicit supersession/retraction, survival beyond the recent Message window, and bounded active selection with a non-silent truncation flag |
