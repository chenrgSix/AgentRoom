...
| WEB-030 | IN_PROGRESS | Refresh Room conversation UI and render safe Markdown | WEB-023, WEB-029 | pending component, build, and real-browser evidence for GFM content, untrusted HTML isolation, streaming/final parity, readable message hierarchy, non-overlaying composition, and light/dark responsive layouts |
