...
| TASK-007 | ACTIVE | Persist versioned Room context checkpoints and historical fences | TASK-006, DATA-006 | migration 0033, repository and reopened-SQLite tests prove immutable contiguous checkpoint chains, recoverable desired watermark/lease state, legacy extractive isolation, and Run-captured Room/Task/Artifact revision fences |
| CON-009 | PLANNED | Define Room context bundle and consumption receipt | TASK-007, CON-007 | positive and negative fixtures plus generated TypeScript/Go types distinguish the Server bundle from Bridge-local consumption, keep the trigger separate, and reject gaps, overlap, truncation, future checkpoints, and provider-native state |
| ADP-013 | PLANNED | Enforce acknowledged Room coverage in managed Runtime Sessions | CON-009, ADP-012 | Codex, Pi, Generic, prompt, and session-store tests prove started/resumed/recreated interval selection, fail-closed bounds, provider-specific acceptance, ambiguous-cut fencing, and no silent Bridge truncation |
| TASK-008 | PLANNED | Schedule recoverable rolling Room reduction | TASK-007, CON-009, ADP-013 | deterministic and configured runner tests prove bounded redacted input, explicit execution ownership, contiguous incremental/rebase commits, lease recovery, desired-watermark drain, independent candidate validation, and quality metrics separate from interval correctness |
| TASK-009 | PLANNED | Add transactional Memory candidate review | TASK-008, TASK-006 | migration 0034, repository/service/API tests prove exact retry dedupe, Member-only list/accept/reject, shared LongTermMemory validation, atomic accepted Memory linkage, and rejection that cannot block checkpoint commit |
| WEB-039 | PLANNED | Review automatic Memory candidates in the Room | TASK-009, WEB-037 | component and browser tests prove authorized pending review, provenance display, accept/reject convergence, responsive layout, and no automatic promotion |
| QA-019 | PLANNED | Verify rolling Room context and candidate review | TASK-008, TASK-009, WEB-039 | committed acceptance records checkpoint backfill/recovery, long-idle resume, historical fences, malformed coverage rejection, provider ambiguity, candidate atomicity, fixed quality evals, and full Node/Go/E2E gates |
