...
test("readiness reports dependency, budget, capacity and authority blockers", () => {
  const cases: Array<[
    ...
    ["dependencyBlocker", "EXECUTION_DEPENDENCY_NOT_MATERIALIZED", "EXECUTION_DEPENDENCY_NOT_MATERIALIZED"],
    ["dependencyBlocker", "EXECUTION_REQUIRED_INPUT_UNSUPPORTED", "EXECUTION_REQUIRED_INPUT_UNSUPPORTED"],
