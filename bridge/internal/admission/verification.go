...
func verificationReceipt(operation execution.RepositoryOperationRequest,
	...
	receipt := execution.VerificationReceipt{Version: 1,
		...
		Authority:       execution.Authority{Kind: execution.KindBridge, DeviceID: &deviceID},
		...
		LogArtifact: &execution.VerificationReceiptLogArtifact{ArtifactID: log.ArtifactID,
