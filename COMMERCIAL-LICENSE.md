...
The community license permits:

- commercial and noncommercial use inside one organization, including its
  controlled affiliates;
- any number of Team, Room, Agent, Device, project, user, or environment
  records for that organization;
- internal software development, operations, and employee collaboration;
- source modification and self-hosting;
...
disaster-recovery, and production environments as a dedicated deployment.
...
The license and this summary should be reviewed by qualified legal counsel
before production commercial reliance.
